    ...
    products: [
        {
            ...
            process: '<p>Este seguro lo cubre todo, desde daños propios hasta asistencia en viaje. Proceso de contratación rápido y sencillo.</p>',
            strengths: '<p>La mejor relación calidad-precio del mercado.</p>',
            observations: '<p>Ninguna.</p>',
        ...
        },
        {
            ...
            process: '<p>Cubre incendios, robos, daños por agua y responsabilidad civil. Inspección y alta en menos de 48 horas.</p>',
            strengths: '<p>Asistencia 24/7 y peritos propios.</p>',
            observations: '<p>Requiere instalación de alarma.</p>',
    ...
    news: [
        {
            ...
            profiles: { name: 'Admin Demo', email: 'admin@demo.com' },
            companies: [],
            categories: [],
            products: [],
        },
